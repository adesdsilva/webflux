...
public class ControllerExceptionsHandler {
    ...
    public ResponseEntity<Mono<ValidationError>> validationException(
            WebExchangeBindException ex, ServerHttpRequest request
    ){
        ValidationError error = new ValidationError(
                now(), request.getPath().toString(), BAD_REQUEST.value(), "Validation Error",
                "Validation Error in attributes");
